...
int main()
{
    ...
    do{
    						  ...
    						  "10)Salir\n", "Opcion invalida.\n", 1, 10, 2, 0))
    	{
			...
			{
				case 1:
					controller_loadFromText("C:\\Users\\Stefano\\eclipse-workspace\\tp3ConTp4\\data.csv",listaEmpleados);
					break;
				case 2:
					controller_loadFromBinary("C:\\Users\\Stefano\\eclipse-workspace\\tp3ConTp4\\databin.csv", listaEmpleados);
					break;
				case 3:
				...
				case 7:
					...
					break;
				case 8:
					controller_saveAsText("C:\\Users\\Stefano\\eclipse-workspace\\tp3ConTp4\\data.csv",listaEmpleados);
					break;
				case 9:
					controller_saveAsBinary("C:\\Users\\Stefano\\eclipse-workspace\\tp3ConTp4\\databin.csv", listaEmpleados);
					break;
			}
    	}
    }while(option != 10);
